...
echo [2] Pyranha				[11] Rendszer info
echo [3] Folder Spammer			[12] Veletlenszeru Jelszo	
echo [4] Show/Hide Files			[13] Pyranha spam on keyboard
echo [5] Open Programs			[14] Kilepes
echo [6] Shutdown				
echo [7] BSOD(Dangerous)			
echo [8] Wifi Hack
echo [9] Change color
echo.
set /p MenuChoose=       
...
echo.
set /p customcolor=
if %customcolor% == 1 goto chngcolor2
...
echo This color will last until you restart the program.
echo I'm working on it the make it stay.
echo.
color help
echo.
pause
